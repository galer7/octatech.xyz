...
import { useParseContact, useCreateContact } from '@/hooks/useContacts';
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-dark-400 mt-1">
            Paste a LinkedIn profile or any text about a person and AI will extract the contact information
          </p>
        </div>
      </div>
        ...
        <CardContent>
          ...
          {parseMutation.isError && (
            <p className="text-red-400 text-sm mt-2">
              Failed to parse text. Please try again.
            </p>
          )}
        </CardContent>
      </Card>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <Badge variant={parsed.confidence >= 0.7 ? 'success' : parsed.confidence >= 0.4 ? 'warning' : 'danger'}>
