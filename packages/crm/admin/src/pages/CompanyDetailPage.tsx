...
export function CompanyDetailPage() {
  ...
  const openEditModal = () => {
    if (company) {
      setEditForm({
        ...
        hiringContractors:
          company.hiringContractors === null
            ? ''
            : company.hiringContractors
              ? 'true'
              : 'false',
        notes: company.notes || '',
    ...
    try {
      await updateMutation.mutateAsync({
        ...
        data: {
          ...
          hiringContractors:
            editForm.hiringContractors === ''
              ? null
              : editForm.hiringContractors === 'true',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            {company.industry && (
              <p className="text-dark-400 mt-1">{company.industry}</p>
            )}
          </div>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{company.size ? formatSize(company.size) : 'Not specified'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {company.contractType ? formatContractType(company.contractType) : 'Not specified'}
                  </p>
                </div>
                <div>
      ...
      {/* Edit Modal */}
      <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} title="Edit Company" size="lg">
