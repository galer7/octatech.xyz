				...
				<CardContent>
					<div className="flex items-center gap-4">
						<div className="h-16 w-16 rounded-full bg-dark-800 flex items-center justify-center">
							<span className="text-2xl font-medium">{user?.email?.[0]?.toUpperCase() || "?"}</span>
						</div>
						<div>
					...
					{isLoadingSettings ? (
						...
						<form onSubmit={handleSaveSettings} className="space-y-4 max-w-md">
							...
							<Input
								...
								onChange={(e) => setSettingsForm({ ...settingsForm, cal_link: e.target.value })}
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-dark-500">
									...
									Sessions are invalidated after 24 hours of inactivity, or 30 days if "Remember me"
									is enabled.
								</p>
							</div>
						</div>
