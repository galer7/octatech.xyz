              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-dark-800">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-dark-400">Response</th>
                    <th className="text-left py-3 px-4 text-sm font-medium text-dark-400">Duration</th>
                    <th className="text-left py-3 px-4 text-sm font-medium text-dark-400">Timestamp</th>
                    <th className="text-right py-3 px-4 text-sm font-medium text-dark-400">Details</th>
                  </tr>
                </thead>
