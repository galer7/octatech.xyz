...
import { useLead, useUpdateLead, useDeleteLead, useAddActivity } from '@/hooks/useLeads';
...
import type { LeadStatus, ActivityType } from '@/lib/types';
...
export function LeadDetailPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-2">
              <Button variant="secondary" className="w-full justify-start" onClick={() => setIsNoteModalOpen(true)}>
      ...
      {/* Edit Modal */}
      <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} title="Edit Lead" size="lg">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Input
              label="Name"
      ...
      <Modal isOpen={isDeleteModalOpen} onClose={() => setIsDeleteModalOpen(false)} title="Delete Lead" size="sm">
      ...
      {/* Add Note Modal */}
      <Modal isOpen={isNoteModalOpen} onClose={() => setIsNoteModalOpen(false)} title="Add Note" size="md">
        <Textarea
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <Button onClick={handleAddNote} isLoading={addActivityMutation.isPending} disabled={!noteText.trim()}>
            Add Note
          </Button>
        </div>
      </Modal>
