...
vi.mock("./discord", () => ({
  discordProvider: {
    send: vi.fn(() =>
      Promise.resolve({ success: true, durationMs: 100, statusCode: 200 })
    ),
...
describe("validateChannelConfig", () => {
  ...
  it("should validate Discord config", () => {
    ...
    const result = validateChannelConfig("discord", config);
  ...
  it("should validate Telegram config", () => {
    ...
    const result = validateChannelConfig("telegram", config);
  ...
  it("should validate Email config", () => {
    ...
    const result = validateChannelConfig("email", config);
